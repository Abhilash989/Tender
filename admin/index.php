...
$password = md5($pass);
  ...
  if($rowcount == 0){echo '<script>alert("Wrong Username or Password");</script>';}
  ...
  while($row = mysqli_fetch_assoc($result)) {
     ...
     //include_once('filemove_test.php');
...
<div class="login-page">
  <center><img src="../IIScLogo.png" alt="IIScLogo" style="width:150px;height:150px;"> </center>
  <div class="form">
    ...
    <!-- <input type="submit" style="background-color: grey" value='Login' name="submit"> -->
